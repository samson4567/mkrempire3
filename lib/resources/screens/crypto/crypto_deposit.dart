...
class _CryptoDepositState extends State<CryptoDeposit> {
    ...
    showModalBottomSheet(
      ...
      builder: (context) {
        return cryptoController.networkList.isEmpty
            ? const Center(
                child: Text("Kindly select crypto"),
              )
            : ListView.builder(
                ...
                itemBuilder: (context, int index) {
                  ...
                  return Container(
                      ...
                      child: ListTile(
                        title:
                            Text(network.chainType, style: const TextStyle()),
                        onTap: () async {
                          ...
                          Navigator.pop(context);
                          await cryptoController.deposit(
                              selectedCrypto!, network.chain);
                          // showNetworkBottomSheet();
  ...
  Widget crypto() {
    ...
    return Column(
      ...
      children: [
        const SizedBox(height: 16),
        const Text("Select Crypto", style: TextStyle()),
        ...
        Obx(() {
          return CustomAppButton(
            bgColor: cryptoController.depositAddressModel.addressDeposit != ""
                ? AppColors.greenColor
                : AppColors.greyColor,
            isLoading: cryptoController.isLoading.value == true,
            onTap: cryptoController.isLoading.value != true
                ? cryptoController.depositAddressModel.addressDeposit != ""
                    ? nextStep
                    : null
                : null,
            text: 'Continue',
  ...
  Widget stepThree() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          // SizedBox(height: 6),
          const Text("Deposit Crypto", style: TextStyle(fontSize: 30)),
          const SizedBox(height: 36),
          Center(
            child: Container(
                width: 100.w,
  ...
  Widget stepTwo() {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          const SizedBox(height: 16),
          const Text("Confirm Transaction", style: TextStyle(fontSize: 30)),
          const SizedBox(height: 16),
          Container(
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [const Text('Coin'), Text("$selectedCrypto")],
          ),
          const Gap(10),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
